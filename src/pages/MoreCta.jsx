  ...
  return (
    <div className="flex flex-col bg-white p-4 h-[400px] align-middle justify-center w-full">
      <div className="flex flex-col text-black mx-auto">
        ...
        <h1 className='font-bold text-[40px] mx-auto w-[400px] sm:w-[300px] sm:text-[30px] pb-4 flex justify-center align-middle'>Let’s Get To Work on your Next Idea!</h1>
        <h1 className='sm:w-[300px]'>Our crew will be happy to help bring your ideas to life</h1>
      </div>
